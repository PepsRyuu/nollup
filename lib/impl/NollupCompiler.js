...
let { applyOutputFileNames, getNameFromFileName, emitAssetToBundle, getModuleInfo } = require('./utils');
...
async function compileModule (context, filePath, parentFilePath, depth, isEntry, emitted, bundleModuleIds) {
    ...
    await PluginLifecycle.hooks.moduleParsed(context, getModuleInfo(context, filePath));
