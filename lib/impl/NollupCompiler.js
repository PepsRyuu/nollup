...
async function compileModule (context, filePath, parentFilePath, depth, isEntry, emitted, bundleModuleIds) {
    ...
    // await Promise.all(file.imports.map(i => {
    //     return compileModule(context, i.source, filePath, depth + 1, false, emitted, bundleModuleIds)
    // })).catch((e) => {
...
module.exports = {
    async compile (context) {
        ...
        try {
            ...
            // TODO: Change to bundleDynamicChunks for emitChunk support
