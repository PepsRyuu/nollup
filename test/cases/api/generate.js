...
describe ('API: generate', () => {
    ...
    it ('should return isEntry, fileName, code, map for chunks', async () => {
        ...
        expect(main1.code.indexOf(`var __ex_default__ = 123; __e__(\\'default\\', function () { return __ex_default__ })`) > -1).to.be.true; 
        expect(main1.code.indexOf(`var __ex_default__ = 456; __e__(\\'default\\', function () { return __ex_default__ })`) > -1).to.be.false;
        ...
        expect(main2.code.indexOf(`var __ex_default__ = 456; __e__(\\'default\\', function () { return __ex_default__ })`) > -1).to.be.true;
        expect(main2.code.indexOf(`var __ex_default__ = 123; __e__(\\'default\\', function () { return __ex_default__ })`) > -1).to.be.false;
